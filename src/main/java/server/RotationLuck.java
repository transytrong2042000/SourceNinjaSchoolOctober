...
public class RotationLuck extends Thread {
    ...
    private void turned() throws Exception {
        ...
        LogHistory.log7("VXMM : " + p.name.toUpperCase() + " da thang " + util.getFormatNumber(amountWin) + " " + currency + " tham gia : " + util.getFormatNumber(p.joinAmount) + " " + currency);
        LogHistory.log8("VXMM : " + p.name.toUpperCase() + " da thang " + util.getFormatNumber(amountWin) + " " + currency + " tham gia : " + util.getFormatNumber(p.joinAmount) + " " + currency);
