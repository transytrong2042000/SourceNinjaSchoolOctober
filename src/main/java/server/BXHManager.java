    ...
    public static void initBXH(final int type) {
        ...
        switch (type) {
            ...
            case 4: {
                ...
                SQLManager.executeQuery("SELECT `name`,`topSK` FROM `ninja` WHERE (`topSK` > 0) ORDER BY `topSK` DESC LIMIT 10;", (red) -> {
                    int i = 1;
                    while (red.next()) {
                        final String name = red.getString("name");
                        final int topsk = red.getInt("topSK");
                        final Entry bXHE = new Entry();
                        bXHE.nXH = new long[1];
                        bXHE.name = name;
                        bXHE.index = i;
            ...
            case 5: {
                ...
                SQLManager.executeQuery("SELECT `name`,`topSK1` FROM `ninja` WHERE (`topSK1` > 0) ORDER BY `topSK1` DESC LIMIT 10;", (red) -> {
                    int i = 1;
                    while (red.next()) {
                        final String name = red.getString("name");
                        final int topsk = red.getInt("topSK1");
                        final Entry bXHE = new Entry();
                        bXHE.nXH = new long[1];
                        bXHE.name = name;
                        bXHE.index = i;
