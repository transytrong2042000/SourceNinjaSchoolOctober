    ...
    static {
        taskTemplates = new TaskTemplate[]{
                builder()
                        ...
                        .detail("Làm hết nhiệm vụ chính tuyến sẽ nhận 1 lần 7 loại ngọc nhé")
                        .build(),
                builder()
                        .taskId(1)
                ...
                builder()
                        .taskId(5)
                        .minLevel(7)
                        .npcTalk("Hái thuốc cứu người là 1 nghĩa cử cao đẹp con có muôn làm không ?")
                ...
                builder()
                        ...
                        .subNames(new String[]{
                                ...
                                "Đánh bù nhìn sử dụng rương thất thú ải",
                                "Báo cáo với Guriin"
                        })
                        .counts(new int[]{
                                -1, 50, 10, -1
                ...
                builder()
                        ...
                        .subNames(new String[]{
                                "Trình độ đạt cấp 67",
                                "Tiêu diệt 10 tinh anh bất kì",
                                "Tiêu diệt 10 thủ lĩnh bất kì",
                                "Báo cáo với Guriin"
                        })
                        .counts(new int[]{
                                -1, 10, 10, -1,
