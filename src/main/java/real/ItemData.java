...
public class ItemData {
    ...
    public static int checkIdSatan(int id) {
        switch (id) {
            case 0: return 774;
        }
        return -1;
    ...
    public static int ThinhLuyenParam(final int id, final int tl) {
        switch (id) {
            ...
            case 76: {
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 50) : 60) : 70) : 90) : 130) : 180) : 250) : 350) : 500; //550, 610, 680, 770, 900, 1080
            }
            ...
            case 78: { //Tăng né tránh cho chủ: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 25) : 30) : 35) : 40) : 50) : 60) : 80) : 115) : 165; //75, 105, 140, 180
            }
            ...
            case 82: //Hp tối đa: #
            case 83: {//Mp tối đa: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 40) : 60) : 80) : 100) : 140) : 220) : 300) : 420) : 590; // done
            }
            case 87: { //Tấn công: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 50) : 60) : 70) : 90) : 130) : 180) : 250) : 350) : 500; //done
            }
            case 88: //Hoả công: +#
            case 89: //Băng công: +#
            case 90: { //Phong lôi: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 50) : 70) : 100) : 140) : 190) : 250) : 320) : 400) : 500; //done
            }
            case 94: { //Tấn công: +#%
            ...
            case 92: { //Chí mạng: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 1) : 5) : 5) : 5) : 10) : 10) : 10) : 10) : 15;
            }
            case 95: //Kháng băng: +#
            case 96: //Kháng hoả: +#
            case 97: { //Kháng phong: +#
                return (tl != 8) ? ((tl != 7) ? ((tl != 6) ? ((tl != 5) ? ((tl != 4) ? ((tl != 3) ? ((tl != 2) ? ((tl != 1) ? ((tl != 0) ? 0 : 5) : 5) : 5) : 5) : 5) : 5) : 10) : 10) : 15; // done
            }
            default: {
                return 0;
            }
    ...
    public static Item itemDefault(final int id) {
        ...
        if (id >= 652 && id <= 655) {
            ...
            if (id == HAI_MA_1_ID || id == DI_LONG_1_ID) {
                item.option.add(new Option(ST_NGUOI_ID, 100));
                item.option.add(new Option(ST_QUAI_ID, 5000));
            } else if (id == HAI_MA_2_ID || id == DI_LONG_2_ID) {
                item.option.add(new Option(ST_NGUOI_ID, 100));
                item.option.add(new Option(ST_QUAI_ID, 10000));
    ...
    public static Item itemNgocDefault(int id, int upgrade, boolean random) {
        ...
        if (id == HUYET_NGOC) {
            ...
            item.option.add(new Option(114, -(random ? util.nextInt((int) (5.8 * CHI_MANG), CHI_MANG) : CHI_MANG)));
            ...
            item.option.add(new Option(73, -(random ? util.nextInt((int) (0.6 * NE_DON), NE_DON) : NE_DON)));

            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(115, random ? util.nextInt((int) (0.8 * NE_DON), NE_DON) : NE_DON));
            item.option.add(new Option(119, -(random ? util.nextInt((int) (5.8 * MOI_GIAY_HOI_PHUC_MP), MOI_GIAY_HOI_PHUC_MP) : MOI_GIAY_HOI_PHUC_MP)));
        }

        if (id == HUYEN_TINH_NGOC) {
            item.option.add(VU_KHI_OPTION);
            item.option.add(new Option(102, random ? util.nextInt((int) (0.8 * ST_CHI_MANG), ST_CHI_MANG) : ST_CHI_MANG));
            item.option.add(new Option(115, -(random ? util.nextInt((int) (0.8 * NE_DON), NE_DON) : NE_DON)));

            item.option.add(TRANG_BI_OPTION);
            item.option.add(new Option(126, random ? util.nextInt((int) (0.8 * PHAN_DON), PHAN_DON) : PHAN_DON));
            item.option.add(new Option(105, -(random ? util.nextInt((int) (0.6 * NE_DON), NE_DON) : NE_DON)));

            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(114, random ? util.nextInt((int) (0.8 * CHI_MANG), CHI_MANG) : CHI_MANG));
            item.option.add(new Option(118, -(random ? util.nextInt((int) (5.8 * KHANG_TAT_CA), KHANG_TAT_CA) : KHANG_TAT_CA)));
        ...
        if (id == LAM_TINH_NGOC) {
            ...
            item.option.add(new Option(120, -(random ? util.nextInt((int) (5.8 * MOI_GIAY_HOI_PHUC_HP), MOI_GIAY_HOI_PHUC_HP) : MOI_GIAY_HOI_PHUC_HP)));

            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(116, random ? util.nextInt((int) (0.8 * CHINH_XAC), CHINH_XAC) : CHINH_XAC));
            item.option.add(new Option(126, -(random ? util.nextInt((int) (5.8 * PHAN_DON), PHAN_DON) : PHAN_DON)));
        ...
        if (id == LUC_NGOC) {
            ...
            item.option.add(TRANG_SUC_OPTION);
            item.option.add(new Option(117, random ? util.nextInt((int) (0.8 * MP_TOI_DA), MP_TOI_DA) : MP_TOI_DA));
            item.option.add(new Option(124, -(random ? util.nextInt((int) (3.8 * GIAM_TRU_ST), GIAM_TRU_ST) : GIAM_TRU_ST)));
    ...
    public static Item itemDefaultMat(int id) {
        ...
        if (id == 685) {
            ...
            item.option.add(new Option(79, 25));
            item.option.add(new Option(64, 0));
            item.option.add(new Option(113, 5000));
            item.setUpgrade(10);
        }
        return item;
    }
